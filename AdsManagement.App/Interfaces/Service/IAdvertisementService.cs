...
namespace AdsManagement.App.Interfaces.Service
{
    public interface IAdvertisementService
    {
        ...
        public Task<PagedResult<ResponceAdvertisementDto>> GetFilterAdsAsync(AdFilterDto filter, CancellationToken token = default);
        public Task<PagedResult<ResponceAdvertisementDto>> GetByUserAdsAsync(Guid userId, UserAdvertisementFilterDto filter, CancellationToken token = default);
